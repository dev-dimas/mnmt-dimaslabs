  ...
  return (
    <div className="flex flex-col min-h-full">
      <div className="min-h-[50vh] max-lg:min-h-[47vh] w-full flex flex-col justify-center items-center gap-4 text-center max-sm:px-2">
        <h1 className="uppercase text-sm font-bold text-zinc-400">Create, Explore, & Collect Digital Art NFTs.</h1>
      ...
      <div className="mb-3 h-1/4 max-lg:flex-1">
        ...
        <CarouselAutoscroll buyerImages={[NFT3, NFT7, NFT1, NFT5, NFT2, NFT8, NFT4, NFT6]} isBackward className="lg:hidden mt-3" />
      </div>
    </div>
  );
}
